...
APRUTIL_EXPORT_INCLUDES="-I/root/mtcp/apps/apache_benchmark/srclib/apr-util/xml/expat/lib"
APRUTIL_EXPORT_LIBS="/root/mtcp/apps/apache_benchmark/srclib/apr-util/xml/expat/libexpat.la"
APRUTIL_LDFLAGS=""
