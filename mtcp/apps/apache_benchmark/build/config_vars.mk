...
shared_build =
AP_LIBS = /root/mtcp/apps/apache_benchmark/srclib/pcre/libpcre.la /root/mtcp/apps/apache_benchmark/srclib/apr-util/libaprutil-1.la /root/mtcp/apps/apache_benchmark/srclib/apr-util/xml/expat/libexpat.la /root/mtcp/apps/apache_benchmark/srclib/apr/libapr-1.la -lrt -lcrypt -lpthread -ldl
AP_BUILD_SRCLIB_DIRS = apr apr-util pcre
AP_CLEAN_SRCLIB_DIRS = apr-util apr pcre
abs_srcdir = /root/mtcp/apps/apache_benchmark
...
EXTRA_CFLAGS = -g -O2 -pthread -I/root/mtcp/mtcp/lib/ -I/root/mtcp/mtcp/src/include/ -DMULTI_THREADED -I/root/mtcp/mtcp/lib/ -I/root/mtcp/mtcp/src/include/ -DMULTI_THREADED
EXTRA_CXXFLAGS =
EXTRA_LDFLAGS = -L/root/mtcp/mtcp/lib/ -lpthread -lnuma -lrt -lmtcp -L/root/mtcp/mtcp/lib/ -lpthread -lnuma -lrt -lmtcp -lgmp
EXTRA_LIBS = -L/root/mtcp/dpdk/lib/ -m64 -g -O3 -pthread -lrt -march=native -Wl,-export-dynamic -Wl,-lnuma -Wl,-lpthread -Wl,-lmtcp -Wl,-lrt -Wl,-ldl -Wl,-lgmp -Wl,
EXTRA_INCLUDES = -I$(top_builddir)/srclib/pcre -I. -I$(top_srcdir)/os/$(OS_DIR) -I$(top_srcdir)/include -I/root/mtcp/apps/apache_benchmark/srclib/apr/include -I/root/mtcp/apps/apache_benchmark/srclib/apr-util/include -I/root/mtcp/apps/apache_benchmark/srclib/apr-util/xml/expat/lib
LIBTOOL = /root/mtcp/apps/apache_benchmark/srclib/apr/libtool $(LTFLAGS)
SHELL = /bin/bash
RSYNC = /usr/bin/rsync
MODULE_DIRS =
MODULE_CLEANDIRS =
...
APR_INCLUDEDIR = /root/mtcp/apps/apache_benchmark/srclib/apr/include
APR_VERSION = 1.4.6
APR_CONFIG = /usr/local/apache2/bin/apr-1-config
APU_BINDIR = /usr/local/apache2/bin
APU_INCLUDEDIR = /root/mtcp/apps/apache_benchmark/srclib/apr-util/include
APU_VERSION = 1.4.1
